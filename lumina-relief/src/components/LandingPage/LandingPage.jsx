    ...
    <div className={styles.container}>
      <header className={styles.hero}>
        <div className={styles.heroContent}>
          ...
          <p>
            Real-time inventory management and logistics for disaster response.
            Ensuring every resource reaches the hands that need it most.
          </p>
      ...
      <section id="mission" className={styles.missionSection}>
        <div className={styles.missionHeader}>
          ...
          <p>
            Every feature is designed to bring speed, transparency, and trust to
        ...
        <div className={styles.featuresGrid}>
          <div className={styles.featureCard}>
            ...
            <p>
              Eliminate dark spots in your supply chain with end-to-end resource
              tracking across every checkpoint.
            </p>
          </div>
          ...
          <div className={styles.featureCard}>
            ...
            <p>
              Automated audit trails ensure every donation is accounted for and
              handled with complete integrity.
            </p>
          </div>
          ...
          <div className={styles.featureCard}>
            ...
            <p>
              Identify high-need zones instantly through our integrated regional
              mapping and AI-powered analytics.
            </p>
          </div>
        </div>
      </section>
      ...
      <section id="how-it-works" className={styles.processSection}>
        ...
        <div className={styles.processGrid}>
          ...
          <div className={styles.processStep}>
            ...
            <p>
              Log incoming donations and supplies with full metadata and photos.
            </p>
          </div>
          ...
          <div className={styles.processStep}>
            ...
            <p>
              On-ground verification with GPS stamps and recipient confirmation.
            </p>
          </div>
